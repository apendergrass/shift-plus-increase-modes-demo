...
%%% cheyenne https://www2.cisl.ucar.edu/resources/cheyenne 

%%% But if you dont, thats ok, any gridded precipiation dataset will do. 
%%% See the companion script for more information. 

%%% 14 January 2016, Angeline Pendergrass, NCAR, Boulder CO. apgrass@ucar.edu
%%% updated 25 July 2019 for cheyenne
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%% CESM LE 
%/glade/collections/cdg/data/cesmLE/CESM-CAM5-BGC-LE/atm/proc/tseries/daily/PRECT
...
filedir='/glade/collections/cdg/data/cesmLE/CESM-CAM5-BGC-LE/atm/proc/tseries/daily/PRECT/';
...
tfiledir='/glade/work/apgrass/p_old/code/lensptimeseries/';
